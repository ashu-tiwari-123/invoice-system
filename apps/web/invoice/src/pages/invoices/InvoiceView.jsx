...
export default function InvoiceView() {
 ...
 const openLivePreview = async () => {
        try {
            ...
            const res = await api.get(`/create-pdf/${id}/pdf-preview`, {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <p className="mt-1 text-sm text-gray-500">The requested invoice could not be loaded.</p>
          <div className="mt-4">
            <button
              onClick={() => navigate(-1)}
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                {invoice.invoiceNo || `INV-${invoice._id?.slice(-6)}`} • {new Date(invoice.invoiceDate).toLocaleDateString()}
              </p>
            </div>
          </div>
          
          <button
            onClick={() => downloadServerPdf(invoice._id, invoice.invoiceNo)}
